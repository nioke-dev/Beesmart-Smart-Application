    ...
    <div class="right">
    			<div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							...
							<tr height="42px"><td>Desa/Kelurahan </td><td>: <td><input class="form-control" type="text" id="txt_h1"  value="<?php echo "$h1"; ?>"/></td></tr>
							<tr height="42px"><td>Login Header 1</td><td>: <td><input class="form-control" type="text" id="txt_h2"  value="<?php echo "$h2"; ?>"/></td></tr>
