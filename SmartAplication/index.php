...
?>
<link href='images/BANNER.png' rel='icon' type='image/png'>
...
<div style="margin-top:0px; bottom:50px; background-color:#dcdcdc; padding:7px; font-size:12px">
    <div class="content">
	<?php if ($teks3=="madipo_cbt"){echo "MADIPO-CBT";}else{echo "SmartAplication-CBT";}?> : <strong> v1_Rev1</strong><br>
	Modified @2020
		<br>
    </div>
</div>
...
<div class="group" style="background-color:<?php echo $warna; ?>;">
    <div  style="background-color:<?php echo $warna; ?>; padding:7px; font-size:12px">
        <center><b><span style="color: #ff0000;"><?php echo strtoupper("$skull"); ?> </span></b> <br> <span style="color: #1B06CF;">Supported by Mursyid</span></center>
    </div>
</footer>
