...
<footer>
    <div  style=" background-color:<?php echo "$r[XWarna]"; ?>; padding:7px; font-size:12px"">
        <p><b><span style="color: #ff0000;"><?php echo strtoupper("$r[XSekolah]"); ?> </b>| <span style="color: #1B06CF;">Supported by MURSYID</span></p>
    </div>
</footer>
-->
<footer style=" width:100%;bottom:0px; background-color:<?php echo "$r[XWarna]"; ?>; position:absolute; margin-top:50px">
    <div class="container" style=" font-size:12px">
        <p><b><span style="color: #ff0000;"><?php echo strtoupper("$r[XSekolah]"); ?> </b><br> <span style="color: #1B06CF;">Supported by MURSYID</span></p>
    </div>
</footer>
